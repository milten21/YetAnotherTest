...
namespace YetAnotherTest.Camera
{
    interface ICamera2D
    {
        /// <summary>
        ...
        /// <summary>
        /// Calculating camera's matrix transformation.
        /// </summary>
        /// <param name="device">Graphics device that is used.</param>
        /// <returns>Camera's matrix transformation.</returns>
        Matrix GetCameraTransformation(GraphicsDevice device);
    }
}
